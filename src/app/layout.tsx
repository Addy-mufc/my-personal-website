  ...
  return (
    <html lang="en">
      ...
      <body className="bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-gray-100 min-h-screen flex flex-col">
        <header className="py-4 fixed w-full z-10 bg-gray-100 dark:bg-gray-900 shadow-md">
          <nav className="container mx-auto px-4 flex justify-between items-center">
            <Link href="/" className="text-xl font-bold hover:text-gray-600 dark:hover:text-gray-300 transition-colors">Home</Link>
            <div className="flex">
              ...
              <Link href="/contact" className="px-4 hover:text-gray-600 dark:hover:text-gray-300 transition-colors">Contact</Link>
            </div>
          </nav>
        </header>
